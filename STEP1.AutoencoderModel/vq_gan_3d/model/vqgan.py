...
class VQGAN(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler_ae = torch.optim.lr_scheduler.MultiStepLR(opt_ae, milestones=[40000, 50000, 60000], gamma=0.1)
        scheduler_disc = torch.optim.lr_scheduler.MultiStepLR(opt_disc, milestones=[40000, 50000, 60000], gamma=0.1)
