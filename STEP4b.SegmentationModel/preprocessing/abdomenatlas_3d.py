...
"""
    ...
    python abdomenatlas_3d.py --src_path /scratch/rpinise1/MultiTumorSynthesis/SyntheticSamplesV1 \
--label_path /scratch/rpinise1/MultiTumorSynthesis/SyntheticSamplesV1 \
--tgt_path /scratch/rpinise1/MultiTumorSynthesis/Synthetic_RSuperProcessed_V1 \
