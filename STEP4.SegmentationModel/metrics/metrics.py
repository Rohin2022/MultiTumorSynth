...
class RadiomicsMetricsEvaluator:
    def __init__(self, feature_list, spacing):
        """
        ...
        self.extractor.enableFeaturesByName(shape=feature_list)
    ...
    def compute_mask(self, tumor_mask):
        ...
        bin_mask_sitk.SetSpacing([float(s) for s in self.spacing])
    ...
    def compute_tumor(self, ct, tumor_mask):
        return