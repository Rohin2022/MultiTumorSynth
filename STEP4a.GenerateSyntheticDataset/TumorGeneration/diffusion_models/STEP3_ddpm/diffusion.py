...
from TumorGeneration.vq_gan_3d.model.vqgan import VQGAN

import matplotlib.pyplot as plt

from .cross_attention_unet import CrossAttention
        ...
        while self.step < self.train_num_steps:
            ...
            if self.step % 2000 == 0:
                ...
                with torch.no_grad():
                    ...
                    latent_denorm = ((noisy_latent + 1.0) /
                                     2.0) * emb_denom + emb_min
                    ...
                    # ---------------------------------------------------
                    # Permute to VQGAN shape  # CHANGED: image_s
                    ...
                    ct_vqgan_recon = decoded_orig.permute(
                    ...
                    # CHANGED: no need to re-min() against batch_size
